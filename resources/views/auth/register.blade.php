        ...
        <div class="form-group{{ old('tab') == 'register' && $errors->has('name') ? ' has-error' : '' }} col-md-12">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input id="name" type="text" placeholder="John Doe" class="form-control" name="name"
        ...
        <div class="form-group{{ old('tab') == 'register' && $errors->has('username') ? ' has-error' : '' }} col-md-12">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input id="username" type="text" class="form-control" placeholder="example" name="username"
